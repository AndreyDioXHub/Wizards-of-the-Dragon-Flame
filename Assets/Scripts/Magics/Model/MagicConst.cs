...
public static class MagicConst
{
    ...
    public static readonly Dictionary<string, ModificatorInfo> MAGICS_MODIFICATOR_BY_KEY = new Dictionary<string, ModificatorInfo>()
    {
        ...
        {MINELIFE, new  ModificatorInfo(2, MINELIFE, 1f, 1, -60f, 1, 0, 0, new List<string>(){LIFE, FORCE2, STUN})},
        {MINEFIRE, new  ModificatorInfo(2, MINEFIRE, 1f, 1, 60f, 1, 1, 0, new List<string>(){FIRE, FORCE2, STUN})},
        {MINEWATER, new  ModificatorInfo(2, MINEWATER, 1f, 1, 60f, 1, 1, 1, new List<string>(){WATER, FORCE2, STUN})},
        {MINEFREEZE, new  ModificatorInfo(2, MINEFREEZE, 1f, 1, 60f, 2, 1, 0, new List<string>(){FREEZE, FORCE2, STUN})},
        {MINERAZOR, new  ModificatorInfo(2, MINERAZOR, 1f, 1, 60f, 1, 2, 0, new List<string>(){RAZOR, FORCE2, STUN, UNARMOR})},
        {MINEDARK, new  ModificatorInfo(2, MINEDARK, 1f, 1, 60f, 2, 1, 0, new List<string>(){DARK, FORCE2, STUN})},
        ...
        {MINEPOISON, new  ModificatorInfo(3, MINEPOISON, 1f, 1, 72f, 2, 1, 0, new List<string>(){POISON, FORCE2, STUN})},
        {MINEICE, new  ModificatorInfo(3, MINEICE, 1f, 1, 72f, 2, 1, 0, new List<string>(){ICE, FORCE2, STUN})},
